<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\Movies_TP5\public/../application/movies\view\index\search.html";i:1607499658;}*/ ?>
...
<?php if(is_array($cxjg) || $cxjg instanceof \think\Collection || $cxjg instanceof \think\Paginator): $i = 0; $__LIST__ = $cxjg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$xw): $mod = ($i % 2 );++$i;?>
    <tr>
        <td></td>       
