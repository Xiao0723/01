<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudy\WWW\tp5\public/../application/movies\view\admin\admin_left.html";i:1604478737;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="menus">
    ...
    <div class="menu" id="menu1">
        ...
        <div class="item">
            <a href="admin" target="admin_middle">修改信息</a>
        </div>
        <li class="item_divider"></li>
        <div class="item">
        ...
        <li class="item_divider"></li>
        <div class="item">
            <a href="admin" target="admin_middle">删除信息</a>
        </div>
    </div>
