<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\WWW\Movies_TP5\public/../application/movies\view\admin\admin_left.html";i:1608877757;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="menus">
    ...
    <div class="menu" id="menu1">
        ...
        <div class="item">
            <a href="admin_upd" target="admin_middle">修改信息</a>
        </div>
        <li class="item_divider"></li>
        <div class="item">
        ...
        <li class="item_divider"></li>
        <div class="item">
            <a href="admin_del" target="admin_middle">删除信息</a>
        </div>
    </div>
