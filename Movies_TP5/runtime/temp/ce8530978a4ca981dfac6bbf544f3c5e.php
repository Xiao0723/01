<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpStudy\WWW\tp5\public/../application/movies\view\index\login.html";i:1605082203;}*/ ?>
...
<style type="text/css">
		...
		section{
			...
			height: 240px;
			margin: 100px auto;
			background: url(/Movies_TP5/public/static//Movies_TP5/public/static/image/v_01.webp) no-repeat;
		...
		section div{
			width: 100%;
			height: 100%;
			background: url(/Movies_TP5/public/static//Movies_TP5/public/static/image/v_10.webp) no-repeat;
			background-size: cover;
			position: absolute;
			top: 20px;
			left: 50px;
